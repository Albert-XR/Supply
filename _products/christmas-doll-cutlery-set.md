...
<div class="breadcrumb">
  <a href="/">Home</a> / <a href="/products">Products</a> / <span>Christmas Doll Spoon & Fork Gift Set</span>
</div>
...
<div class="product-main">
  ...
  <div class="product-gallery">
    <img src="/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-01.jpg" alt="Christmas Cartoon Doll Gold-Plated Spoon & Fork Gift Box Set" class="main-image" id="mainImage">
    <div class="thumbnail-list">
      <img src="/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-01.jpg" class="thumbnail active" loading="lazy" onclick="changeImage(this, '/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-01.jpg')">
      <img src="/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-02.jpg" class="thumbnail" loading="lazy" onclick="changeImage(this, '/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-02.jpg')">
      <img src="/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-03.jpg" class="thumbnail" loading="lazy" onclick="changeImage(this, '/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-03.jpg')">
      <img src="/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-04.jpg" class="thumbnail" loading="lazy" onclick="changeImage(this, '/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-04.jpg')">
  ...
  <div class="product-info">
    ...
    <div class="feature-tags">
      ...
      <span class="tag">✓ Titanium Gold Plated</span>
      <span class="tag">✓ Dishwasher Safe</span>
      <span class="tag">✓ 2 / 4 / 6-Piece Gift Boxes</span>
    ...
    <div class="quick-inquiry">
      ...
      <form action="https://api.web3forms.com/submit" method="POST">
        ...
        <input type="hidden" name="subject" value="New Inquiry: Christmas Doll Spoon & Fork Gift Set">
        ...
        <div class="form-row">
          <div class="form-group">
            <select name="quantity" required>
              ...
              <option value="80-500">80 - 500 pieces</option>
    ...
    <p style="font-size:0.9em; color:#666;">
      ...
      <a href="mailto:sales@ding-yong.com?subject=Sample Request: Christmas Doll Spoon & Fork Gift Set" style="color:#e94560;">Request Sample &rarr;</a>
    </p>
  </div>
...
<div class="product-tabs">
  ...
  <div id="specs" class="tab-content active">
    ...
    <table class="spec-table">
      ...
      <tr><td>Topper Material</td><td>PVC Cartoon Doll (Food-Safe)</td></tr>
      <tr><td>Finish</td><td>Titanium Gold Plated, Mirror Polished</td></tr>
      <tr><td>Doll Designs</td><td>Santa / Christmas Tree / Snowman / Santa Hat / Stocking / Reindeer (6 designs)</td></tr>
      <tr><td>Dessert Spoon Size</td><td>15.5 - 17 cm, 19.4 - 24 g</td></tr>
      <tr><td>Dinner Spoon Size</td><td>Approx. 41 - 46 g</td></tr>
      <tr><td>Dessert Fork Size</td><td>18 cm, 14.6 - 19.4 g</td></tr>
      <tr><td>Dinner Fork Size</td><td>18 cm, 31 - 36 g</td></tr>
      <tr><td>Dishwasher Safe</td><td>Yes</td></tr>
      <tr><td>Features</td><td>Non-toxic, heat resistant, smooth polished edges</td></tr>
      <tr><td>Customization</td><td>Custom doll designs, box printing, logo</td></tr>
    </table>

    <h3 style="margin-top:30px;">Cartoon Designs</h3>
    <div style="display:flex; gap:15px; flex-wrap:wrap; margin:15px 0;">
      <div style="text-align:center;"><div style="width:60px; height:60px; background:linear-gradient(135deg, #E53935, #B71C1C); border-radius:50%; margin-bottom:5px;"></div><span style="font-size:0.85em;">Santa</span></div>
      <div style="text-align:center;"><div style="width:60px; height:60px; background:linear-gradient(135deg, #43A047, #1B5E20); border-radius:50%; margin-bottom:5px;"></div><span style="font-size:0.85em;">Christmas Tree</span></div>
      <div style="text-align:center;"><div style="width:60px; height:60px; background:linear-gradient(135deg, #FAFAFA, #BDBDBD); border-radius:50%; margin-bottom:5px;"></div><span style="font-size:0.85em;">Snowman</span></div>
      <div style="text-align:center;"><div style="width:60px; height:60px; background:linear-gradient(135deg, #E53935, #FFF59D); border-radius:50%; margin-bottom:5px;"></div><span style="font-size:0.85em;">Santa Hat</span></div>
      <div style="text-align:center;"><div style="width:60px; height:60px; background:linear-gradient(135deg, #C62828, #E57373); border-radius:50%; margin-bottom:5px;"></div><span style="font-size:0.85em;">Stocking</span></div>
      <div style="text-align:center;"><div style="width:60px; height:60px; background:linear-gradient(135deg, #8D6E63, #5D4037); border-radius:50%; margin-bottom:5px;"></div><span style="font-size:0.85em;">Reindeer</span></div>
    </div>
  </div>
  ...
  <div id="packaging" class="tab-content">
    ...
    <div class="packaging-show">
      <div class="pack-item">
        <img src="/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-02.jpg" alt="6-Piece Christmas Gift Box">
        <h4>6-Piece Box</h4>
        <p style="font-size:0.85em; color:#666;">18.2 × 18.5 cm, window display, festive print.</p>
      </div>
      <div class="pack-item">
        <img src="/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-06.jpg" alt="4-Piece Christmas Gift Box">
        <h4>4-Piece Box</h4>
        <p style="font-size:0.85em; color:#666;">15 × 18.7 cm, retail-ready gift packaging.</p>
      </div>
      <div class="pack-item">
        <img src="/assets/images/christmas-doll-cutlery-set/christmas-doll-cutlery-set-03.jpg" alt="2-Piece Christmas Gift Box">
        <h4>2-Piece Box</h4>
    ...
    <div style="background:#f8f9fa; padding:20px; border-radius:10px; margin-top:20px;">
      ...
      <table class="spec-table">
        <tr><td>Box Styles</td><td>2-piece / 4-piece / 6-piece sets with display window</td></tr>
